...
val baseApplicationId = "com.halalatune.music"
val applicationIdOverride = System.getenv("HALALATUNE_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("HALALATUNE_APP_NAME")?.takeIf { it.isNotBlank() }
val debugKeystorePathOverride = System.getenv("HALALATUNE_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("HALALATUNE_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("HALALATUNE_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("HALALATUNE_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
...
android {
    namespace = "com.halalatune.music"
    compileSdk = 36
    ...
    defaultConfig {
        ...
        versionCode = 145
        versionName = "13.4.1"
        resValue("string", "app_name", appNameOverride ?: "Halalatune")
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "Halalatune Debug")
            }
            signingConfig =
...
dependencies {
    ...
    implementation(project(":halalfilter"))
